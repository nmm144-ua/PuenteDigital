          ...
          <div class="card profile-card">
            <div class="card-header">
              <div class="profile-header">
                <div class="profile-avatar">
                  <span>{{ form.nombre ? form.nombre.charAt(0).toUpperCase() : 'U' }}</span>
                </div>
              ...
              <button 
                ...
                @click="toggleEditing"
              >
                <i :class="isEditing ? 'bi bi-x-lg' : 'bi bi-pencil'"></i>
            ...
            <div class="card-body p-4">
              ...
              <div class="actions-footer">
                <button 
                  @click="eliminarAsistente(form.id)" 
                ...
                <router-link to="/asistente" class="btn back-button">
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="confirmacionModalLabel">{{ modalTitulo }}</h5>
  ...
  setup() {
    ...
    const eliminarAsistente = (id) => {
      mostrarConfirmacion(
        ...
        `Debido a motivos de seguridad y privacidad, no se puede eliminar la cuenta. Aún así ¿quiere suspender su cuenta y solicitar la eliminación de sus datos?`,
        async () => {
          try {
            loading.value = true;
            await asistenteService.desactivarAsistente(id);
            await supabase.auth.signOut();
            router.push('/login');
          } catch (error) {
            console.error('Error al suspender asistente:', error);
            alert('No se pudo suspender la cuenta');
          } finally {
            loading.value = false;
          }
        }
